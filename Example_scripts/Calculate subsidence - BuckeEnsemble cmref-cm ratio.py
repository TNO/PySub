...
if __name__ == "__main__":
    ...
    import_paths = [
        r".\BucketEnsemble\Allardsoog - cmref-cm ratio.json",
    ...
    model = build_bucket_ensemble(
        import_paths, name="BucketEnsemble_test_ratio", project_folder=project_folder
    )
    ...
    results, error = model.calculate_samples(
        number_of_samples=number_of_samples, all_timesteps=True, seed=9090
    )
    (
        _,
        (p90, p50, p10),
