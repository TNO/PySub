...
if __name__ == '__main__':
    ...
    import_paths = [r".\BucketEnsemble\Allardsoog.json",
                    r".\BucketEnsemble\Een.json"]
    
    # Project folder is required for running bucket ensemble
    project_folder = os.getcwd() 
    
    model = build_bucket_ensemble(import_paths, name = 'BucketEnsemble_test', 
    ...
    results, error = model.calculate_samples(number_of_samples = number_of_samples, all_timesteps = True) 
