...
This workflow samples ramdomly from the bucket ensembles. A bucket:

bucket = {"parameter": {"value": [1000, 1250, 1900], "probabilities": [0.1, 0.5, 0.4]}}

Each realisation will sample parameter values randomly, with the probabilities linked to that value.
"""
